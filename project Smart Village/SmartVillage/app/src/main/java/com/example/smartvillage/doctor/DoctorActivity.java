        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mbbs.setLayoutManager(new LinearLayoutManager(DoctorActivity.this));
                    adapter = new DoctorAdapter(list1,DoctorActivity.this,"MBBS");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DoctorActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void bhms() {
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    bhms.setLayoutManager(new LinearLayoutManager(DoctorActivity.this));
                    adapter = new DoctorAdapter(list2,DoctorActivity.this,"BHMS");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    byns.setLayoutManager(new LinearLayoutManager(DoctorActivity.this));
                    adapter = new DoctorAdapter(list3,DoctorActivity.this,"BYNS");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    bums.setLayoutManager(new LinearLayoutManager(DoctorActivity.this));
                    adapter = new DoctorAdapter(list4,DoctorActivity.this,"BUMS");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    others.setLayoutManager(new LinearLayoutManager(DoctorActivity.this));
                    adapter = new DoctorAdapter(list5,DoctorActivity.this,"Others");
