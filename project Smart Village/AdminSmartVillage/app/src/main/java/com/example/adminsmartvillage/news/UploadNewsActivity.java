...
public class UploadNewsActivity extends AppCompatActivity {
    ...
    private ImageView newsImagePreview;
    private EditText newsTitle, newsDescription;
    private Button uploadNewsButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsImagePreview = findViewById(R.id.newsImagePreview);
        newsTitle = findViewById(R.id.newsTitle);
        newsDescription = findViewById(R.id.newsDescription);
        uploadNewsButton = findViewById(R.id.uploadNewsButton);
        ...
        uploadNewsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                else if(newsDescription.getText().toString().isEmpty())
                {
    ...
    private void uploadData() {
        ...
        NewsData newsData = new NewsData(downloadUrl, title, description,date, time, uniqueKey);
        dbRef.child(uniqueKey).setValue(newsData).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(UploadNewsActivity.this, "News Upload Successfully", Toast.LENGTH_SHORT).show();
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == REQ && resultCode == RESULT_OK)
        {
            ...
            newsImagePreview.setImageBitmap(bitmap);
